...
save_folder = '/shared/ssd_16T/yl535/project/python/datasets/havo_crosssectional_new_export/crosssectional_v1_oct'
...
count = 1
for pid in upids:
    for k in range(1): # range(len(rnflt_maps[pid])):
        ind = random.randint(0, len(rnflt_maps[pid])-1)
        rnflt = rnflt_maps[pid][ind]
        glaucoma, md, tds, octID, datadir, clockhours = rnflt_attrs[pid][ind]
        ...
        np.savez(save_cross_folder_oct, bscans=bscans)
