...
def create_model(model_type='efficientnet', in_dim=1, out_dim=1, number_layer = 1, use_pretrained=True, include_final=True):
    ...
    elif model_type == 'cond_vit':
        vit_model = vit_b_16(weights=ViT_B_16_Weights.IMAGENET1K_V1)
        classification_model = Cond_VIT(vit_model, 16, 768, 12, 3, 197, number_layer, 3072, 0.0, 0.0, out_dim)
