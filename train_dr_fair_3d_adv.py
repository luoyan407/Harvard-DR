...
def train(model, criterion, optimizer, scaler, \
          train_dataset_loader, epoch, total_iteration, \
            imbalanced_info=None, adv_model=None, \
                adv_criterion=None, adv_optimizer=None):
    global device
...
if __name__ == '__main__':
    ...
    for epoch in range(start_epoch, args.epochs):
        train_loss, train_acc, train_auc, trn_preds, trn_gts, trn_attrs, trn_pred_gt_by_attrs, trn_other_metrics = train(model, criterion, optimizer, scaler, train_dataset_loader, epoch, total_iteration, imbalanced_info=imb_info,  adv_model=adv_model, adv_criterion=adv_criterion,  adv_optimizer=adv_optimizer)
